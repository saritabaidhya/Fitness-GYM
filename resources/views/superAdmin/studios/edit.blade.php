        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3">
                <div class="music-item">
                  <a href="#" class="music-thumb mb-3"><img src="{{ asset('storage/app/public/images/' . $image) }}" alt="" class="img-fluid"></a>
...
@endif
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($studio->path)
                                    <img src="{{ asset('storage/app/public/images/' . $studio->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
                            </div>   
                        </div>
