            ...
            <table  id="datatable-buttons" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{ $connect->name }}</td>
                     <td>{{ $connect->email }}</td>
                     <td>{{ $connect->category }}</td>
                     <td>{{ $connect->created_at }}</td>
                     <td>{{ $connect->updated_at }}</td>
                     <td>
                        <a href="" class="dropdown-link" data-bs-toggle="dropdown" aria-expanded="false"><i class="ri-more-2-fill"></i></a>
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('connects.show',$connect->id) }}" data-toggle="modal" class="dropdown-item details"><i class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('connects.edit',$connect->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>Edit</a>                           
                           <a href="#modal-{{$connect->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i class="ri-delete-bin-line"></i> Delete</a>
                        </div>
                     </td>
                  </tr>
