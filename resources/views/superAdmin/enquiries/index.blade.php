...
<div class="d-flex align-items-center justify-content-between mb-4">
   <div>
      <ol class="breadcrumb fs-sm mb-1">
         ...
         <li class="breadcrumb-item active" aria-current="page">Membership Enquiry List</li>
      </ol>
...
<div class="row g-3 justify-content-center">
   <div class="card card-one mt-3">
      <div class="card-header">
         <h6 class="card-title">Membership Enquiry List</h6>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('enquiries.show',$enquiry->id) }}" data-toggle="modal" class="dropdown-item details"><i class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('enquiries.edit',$enquiry->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>Edit</a>                           
                           <a href="#modal-{{$enquiry->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i class="ri-delete-bin-line"></i> Delete</a>
                        </div>
                     </td>
                  </tr>

                  <div class="modal fade" id="modal-{{$enquiry->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$enquiry->name }} </strong></div>
                            </div>
