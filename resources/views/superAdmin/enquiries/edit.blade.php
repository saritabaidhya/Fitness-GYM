        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item"><a href="/enquirytypes">Membership Enquiry</a></li>
        ...
        <div class="row g-3 justify-content-center">
            <div class="card card-one mt-3">
                <div class="card-header">
                    <h6 class="card-title">Edit Membership Enquiry</h6>
                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$enquiry->name}}" class="form-control"  placeholder="Enter enquiry name">
                                  </div>  

                                  <div class="mb-3">
                                    <label  class="form-label">Descriptions</label>
                                    <textarea id="basic-conf" class="form-control" name="detail" rows="3" placeholder="Write here..."> {{$enquiry->detail}}</textarea>
                                  </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="status" aria-label="Default select example">
                                    ...
                                    <option value="0" {{ $enquiry->status  == '0' ? 'selected' : '' }}>Inactive</option>
                                  </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($enquiry->path)
                                        <img src="{{ asset('storage/app/public/images/' . $enquiry->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                    @endif
                                </div>
                            </div>   
                        </div>
