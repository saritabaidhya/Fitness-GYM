         ...
         <div class="row">
            <div class="col-md-8">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="mb-3">
                        ...
                        <input type="text" name="time" value="{{$setting->first()->time}}" class="form-control"  placeholder="Enter opening Hours">
                     </div>
                  </div>
               </div>
             ...
             <div class="mb-3">
               ...
               <input type="text" name="title" value="{{$setting->first()->title}}" class="form-control"  placeholder="Enter meta title">
            </div>
               <div class="mb-3">
            ...
            <div class="col-md-4">
               <div class="mb-3">
                  <div class="mb-3">
                     ...
                     @if ($setting->path)
                     <img src="{{ asset('storage/app/public/images/' . $setting->first()->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                     @endif
                  </div>
               </div>
