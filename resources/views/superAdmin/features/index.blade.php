   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="{{ route('features.create')}}" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Feature</a>
         </nav>
      </div>
            ...
            <table  id="datatable" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>{{$feature->name}}</td>
                     <td><span class="">{{$feature->status}}</span></td>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="{{ route('features.show',$feature->id) }}" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="{{ route('features.edit',$feature->id) }}" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-{{$feature->id }}" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-{{$feature->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> {{$feature->name }} </strong> </div>
                            </div>
