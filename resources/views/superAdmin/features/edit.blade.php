            ...
            <div class="card card-one mt-3">
                <div class="card-header">
                    ...
                    <nav class="nav nav-icon nav-icon-sm ms-auto">
                        <a href="{{ route('features.index')}}" class="btn btn-primary btn-icons"><i class="ri-arrow-left-line me-2"></i> Back</a>
                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$feature->name}}" class="form-control"  placeholder="Enter feature name">
                                </div> 
                                <div class="mb-3">
                                    <label  class="form-label">Icon</label>
                                    <input type="text" name="icon" value="{{$feature->icon}}" class="form-control"  placeholder="Feature icon">
                                </div>  

                                  <div class="mb-3">
                                    <label  class="form-label">Descriptions</label>
                                    <textarea id="basic-confd" class="form-control" name="detail" rows="3" placeholder="Write here..."> {{$feature->detail}}</textarea>
                                  </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($feature->path)
                                    <img src="{{ asset('storage/app/public/images/' . $feature->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
