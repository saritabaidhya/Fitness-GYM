            ...
            <div class="row">
               <div class="col-md-8">
                  ...
                  <div class="mb-3">
                     ...
                     <input type="text" name="title" class="form-control"  placeholder="Enter meta title">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                     ...
                     <textarea class="form-control" name="highlights" rows="3" placeholder="Write here..."></textarea>
                  </div>
                  <div class="mb-3">
               ...
               <div class="col-md-4">
                  ...
                  <div class="mb-3">
                     ...
                     <select class="form-select" name="category" aria-label="Default select example">
                        ...
                        <option value="{{$utilitytype->id}}" selected>{{$utilitytype->name}}</option>
                       @endforeach
                     </select>
                  </div>
                  <div class="mb-3">
