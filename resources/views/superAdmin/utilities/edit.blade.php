                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="title" value="{{$utility->title}}" class="form-control"  placeholder="Enter meta title">
                                 </div>
                                 <div class="mb-3">
                                    <label  class="form-label">Icon</label>
                                    <input type="text" name="icon" value="{{$utility->icon}}" class="form-control"  placeholder="Enter icon">
                                  </div> 

                                  <div class="mb-3">
                                    <label  class="form-label">Highlights</label>
                                    <textarea  class="form-control" name="highlights" rows="3" placeholder="Write here..."> {{$utility->highlights}}</textarea>
                                  </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="category" aria-label="Default select example">
                                        ...
                                        <option value="{{ $utilitytype->id }}" 
                                            {{ $utility->category == $utilitytype->id ? 'selected' : '' }}>
                                            {{ $utilitytype->name }}
                                        </option>
                                    @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($utility->path)
                                    <img src="{{ asset('storage/app/public/images/' . $utility->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($utility->path1)
                                    <img src="{{ asset('storage/app/public/images/' . $utility->path1) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
