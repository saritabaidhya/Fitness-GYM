                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    <label  class="form-label">Descriptions</label>
                                    <textarea id="basic-conf" class="form-control" name="minidetail" rows="3" placeholder="Write here..."> {{$slider->detail}}</textarea>
                                  </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($slider->path)
                                    <img src="{{ asset('storage/app/public/images/' . $slider->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
                            </div>   
                        </div>
