                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($squad->path)
                                    <img src="{{ asset('storage/app/public/images/' . $squad->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>

                                <div class="mb-3">
                                    <label  class="form-label">Email</label>
                                    <input type="text" name="email"  class="form-control" value="{{$squad->email}}"  placeholder="Enter email address">
                                 </div>
