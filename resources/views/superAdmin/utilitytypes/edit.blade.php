                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$utilitytype->name}}" class="form-control"  placeholder="Enter utilitytype name">
                                  </div> 
                                  
                                  <div class="mb-3">
                                    <label  class="form-label">Meta Title</label>
                                    <input type="text" name="title" value="{{$utilitytype->title}}" class="form-control"  placeholder="Enter meta title">
                                  </div> 
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($utilitytype->path)
                                    <img src="{{ asset('storage/app/public/images/' . $utilitytype->path) }}" alt="Current Image" class="img-thumbnail mt-3" >
                                @endif
                                </div>
