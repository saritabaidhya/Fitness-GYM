      ...
      <div class="col-md-7 col-lg-5 col-xl-4 col-wrapper">
        <div class="card card-sign">
          <div class="card-header">
            <a href="../index.html" class="header-logo mb-5"><?php echo e($settings->first()->name); ?></a>
            <h3 class="card-title">Sign Up</h3>
            <p class="card-text">It's free to signup and only takes a minute.</p>
          </div><!-- card-header -->
          <div class="card-body">
          <form action="<?php echo e(route('signups.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
          ...
          <div class="card-footer">
            Already have an account? <a href="/enlists">Sign In</a>
          </div><!-- card-footer -->
        </div><!-- card -->
      </div><!-- col -->
    </div><!-- row -->
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/frontEnd/signups/index.blade.php ENDPATH**/ ?>