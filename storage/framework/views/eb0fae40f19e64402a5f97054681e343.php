   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="<?php echo e(route('sliders.create')); ?>" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Slider</a>
         </nav>
      </div>
            ...
            <table  id="datatable" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><span class=""><?php echo e($slider->status); ?></span></td>
                     ...
                     <td>
                        ...
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="<?php echo e(route('sliders.show',$slider->id)); ?>" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="<?php echo e(route('sliders.edit',$slider->id)); ?>" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-<?php echo e($slider->id); ?>" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-<?php echo e($slider->id); ?>" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong> <?php echo e($slider->name); ?> </strong></div>
                            </div>
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/superAdmin/sliders/index.blade.php ENDPATH**/ ?>