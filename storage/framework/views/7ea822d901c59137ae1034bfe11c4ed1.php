   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="<?php echo e(route('studios.create')); ?>" class="btn btn-primary btn-icons"><i class="ri-add-fill"></i> Add
            Gallery</a>
         </nav>
      </div>
            ...
            <table  id="datatable" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0;">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><?php echo e($studio->name); ?></td>
                     <td><?php echo e($studio->created_at); ?></td>
                     <td><?php echo e($studio->updated_at); ?></td>
                     <td>
                        <a href="" class="dropdown-link" data-bs-toggle="dropdown"
                           aria-expanded="false"><i class="ri-more-2-fill"></i></a>
                        <div class="dropdown-menu dropdown-menu-end" style="">
                           <a href="<?php echo e(route('studios.show',$studio->id)); ?>" data-toggle="modal" class="dropdown-item details"><i
                              class="ri-menu-4-line"></i> View Details</a>
                           <a href="<?php echo e(route('studios.edit',$studio->id)); ?>" class="dropdown-item rename"><i class="ri-edit-2-line"></i>
                           Edit</a>
                           
                              <a href="#modal-<?php echo e($studio->id); ?>" data-bs-toggle="modal" class="dropdown-item delete"><i
                  ...
                  <div class="modal fade" id="modal-<?php echo e($studio->id); ?>" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row"> 
                                ...
                                <div class="col-md-9"><h5>This can't be undone. </h5> You are about to delete the information of <strong><?php echo e($studio->name); ?></strong> </div>
                            </div>
                            
                        </div><!-- modal-body -->
                        <div class="modal-footers text-end pb-2 pe-4">
                            <form action="<?php echo e(route('studios.destroy',$studio->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/superAdmin/studios/index.blade.php ENDPATH**/ ?>