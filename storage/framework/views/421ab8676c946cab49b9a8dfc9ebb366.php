                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="<?php echo e($package->name); ?>" class="form-control"  placeholder="Enter package name">
                                  </div>  
                                  <div class="mb-3">
                                    <label  class="form-label">Amount</label>
                                    <input type="text" name="amount" value="<?php echo e($package->amount); ?>" class="form-control"  placeholder="Enter package name">
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                        <?php
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if($package->path): ?>
                                    <img src="<?php echo e(asset('storage/app/public/images/' . $package->path)); ?>" alt="Current Image" class="img-thumbnail mt-3" >
                                <?php endif; ?>
                                </div>

                                <div class="mb-3">
                                    <label  class="form-label">Email</label>
                                    <input type="text" name="email"  class="form-control" value="<?php echo e($package->email); ?>"  placeholder="Enter email address">
                                 </div>
                    
                                 <div class="mb-3">
                                    <label  class="form-label">Meta Descriptions</label>
                                    <input type="text" name="facebook"  class="form-control" value="<?php echo e($package->facebook); ?>"  placeholder="Enter facebook profile link">
                                 </div>
                            </div>   
                        </div>
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/superAdmin/packages/edit.blade.php ENDPATH**/ ?>