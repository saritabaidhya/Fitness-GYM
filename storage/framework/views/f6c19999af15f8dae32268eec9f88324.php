        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e($slider->title); ?></li>
                </ol>
                        ...
                        <div class="row"> 
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" value="<?php echo e($slider->name); ?>" class="form-control"  placeholder="Enter Slider name">
                                  </div>  

                                  <div class="mb-3">
                                    <label  class="form-label">Descriptions</label>
                                    <textarea id="basic-conf" class="form-control" name="detail" rows="3" placeholder="Write here..."> <?php echo e($slider->detail); ?></textarea>
                                  </div>

                                  <div class="mb-3">
                                    <label  class="form-label">Descriptions</label>
                                    <textarea id="basic-conf" class="form-control" name="minidetail" rows="3" placeholder="Write here..."> <?php echo e($slider->detail); ?></textarea>
                                  </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if($slider->path): ?>
                                    <img src="<?php echo e(asset('storage/app/public/images/' . $slider->path)); ?>" alt="Current Image" class="img-thumbnail mt-3" >
                                <?php endif; ?>
                                </div>
                            </div>   
                        </div>
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/superAdmin/sliders/edit.blade.php ENDPATH**/ ?>