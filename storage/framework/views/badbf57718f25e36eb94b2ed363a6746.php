   ...
   <div class="card card-one mt-3">
      <div class="card-header">
         ...
         <nav class="nav nav-icon nav-icon-sm ms-auto">
            <a href="<?php echo e(route('stories.edit', $stories->first()->id)); ?>" class="btn btn-primary btn-icons"><i class="ri-edit-2-line"></i> Edit
               About Us</a>
         </nav>
      </div>
      <div class="card-body p-3">
         <div class="media-profile mb-5">
            ...
            <div class="media-body">
              <h5 class="media-name"><?php echo e($stories->first()->name); ?></h5>
              <div class="mt-3"><?php echo $stories->first()->detail; ?></div>
            </div><!-- media-body -->
          </div>
...
<?php echo $__env->make('layouts.superAdmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/superAdmin/stories/index.blade.php ENDPATH**/ ?>