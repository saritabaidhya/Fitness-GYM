<div class="sidebar">
    <div class="sidebar-header">
        <a href="/dashboards" class="sidebar-logo"><?php echo e($settings->first()->name); ?></a>
    </div>
    <!-- sidebar-header -->
    <div id="sidebarMenu" class="sidebar-body">
        ...
        <div class="nav-group show">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link has-sub"><i class="ri-gallery-fill"></i> <span>Services</span></a>
                ...
                <li class="nav-item">
                    <a href="/features" class="nav-link"><i class="ri-file-paper-line"></i> <span>Features</span></a>
                </li>
                <li class="nav-item">
                    <a href="/journals" class="nav-link"><i class="ri-movie-2-line"></i> <span>Blogs</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="/squads" class="nav-link"><i class="ri-team-line"></i> <span>Teams</span></a>
                </li>
                <li class="nav-item">
                    <a href="/packages" class="nav-link"><i class="ri-currency-line"></i> <span>Packages</span></a>
                </li>
                <li class="nav-item">
        ...
        <div class="nav-group show">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-item">
                    <a href="/enquiries" class="nav-link"><i class="ri-chat-quote-line"></i> <span>Membership Enquiry </span></a>
                </li>
...
<div class="header-main px-3 px-lg-4">
    ...
    <div class="dropdown dropdown-notification ">
        <a href="/" target="_blank" class="dropdown-link"><i class="ri-earth-line"></i></a>
                ...
                <li class="list-group-item">
                    ...
                    <div class="list-group-body">
                        <p>Reminder: <strong>Jerry Cuares</strong> invited you to like <strong>Cuares Surveying Services</strong>.
                            <br><a href="#">Accept</a> or <a href="#">Decline</a></p>
    ...
    <div class="dropdown dropdown-profile ms-3 ms-xl-4">
        <a href="#" class="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
            <div class="avatar online"><img src="<?php echo e(asset('public/superAdmin/img/avatar.png')); ?> " alt=""></div>
        </a>
        <div class="dropdown-menu dropdown-menu-end mt-10-f">
            <div class="dropdown-menu-body">
                ...
                <nav class="nav">
                    ...
                    <a href="<?php echo e(route('signout')); ?>"><i class="ri-logout-box-r-line"></i> Log Out</a>
                </nav>
            </div>
            <!-- dropdown-menu-body -->
        </div>
...
<!-- header-main --><?php /**PATH C:\xampp\htdocs\Gym Fitness\resources\views/layouts/superAdmin/header.blade.php ENDPATH**/ ?>